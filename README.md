...
- **FastAPI** - Framework moderno para APIs REST con Python
- **JavaScript** - DOM, funciones flecha, algoritmos
- **Node.js** - Runtime de JavaScript para backend
- **HTML5 & CSS3** - Maquetación web
- **Sass/SCSS** - Preprocesador CSS: variables, mixins, herencia
- **PostgreSQL & MySQL** - Bases de datos relacionales, conexiones y transacciones
...
⭐ *"Good code, like wisdom, keeps it simple. There's always more to learn."*
